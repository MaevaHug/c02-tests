...
cc -Wall -Wextra -Werror -o ft_strlowcase ft_strlowcase.c main.c
if [ $? -ne 0 ]; then
...
longest_test="$> ./ft_strlowcase \"Hello World\""
...
run_test "HELLO123" "hello123" || all_tests_passed=false
