...
cc -Wall -Wextra -Werror -o ft_str_is_lowercase ft_str_is_lowercase.c main.c
if [ $? -ne 0 ]; then
...
longest_test="$> ./ft_str_is_lowercase \"abc def\""
...
run_test() {
	...
	echo "$separator"
	echo "$> ./ft_str_is_lowercase \"$input\""

	output=$(./ft_str_is_lowercase "$input")
